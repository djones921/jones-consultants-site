...
SERVICES = [
 dict(slug="project-engineering", n="01",
  ...
  process="Most engagements begin with a short scoping conversation about where the project stands, followed by a written proposal. On approval we set up the project execution plan in the first two weeks: stage gates, deliverables register, reporting cadence, and decision authority. From there the engagement runs at the intensity the phase demands: design reviews and gate packages during design, field presence during construction, protocol execution during CQV. The same engineer carries the project across phases; for larger programs we add project engineers, project managers, and CQV leads under the same accountability.",
 ...
 dict(slug="engineering-design", n="02",
  ...
  scope=[
   ...
   "<strong>Utilities and environment.</strong> Clean utilities (WFI, clean steam, process gases), black utilities (chilled water, heating hot water, steam, soft water), process chillers, and cleanroom HVAC, including air changes, pressure cascades, and equipment load.",
  ...
  why="Our design experience comes from the owner's side of operating facilities, where the same engineer who specified the check valve later executed the IQ and watched operators run the system. That produces designs that are maintainable, cleanable, and qualifiable, not just code-compliant. Design work is delivered under a licensed North Carolina engineering firm by a licensed Professional Engineer.",
  faq=[
   ...
   ("Can you design against single-use as well as stainless platforms?", "Yes. The design consequences differ in utility loads, CIP/SIP scope, footprint, changeover, and waste, and we work through those trade-offs in the concept phase rather than after equipment is ordered."),
 ...
 dict(slug="cqv", n="04",
  ...
  why="We have led CQV on large-scale biologics site startups covering drug substance, drug product filling and inspection, and site-wide black utilities, and executed FAT, SAT, and IQ/OQ for filling, inspection, spray drying, chiller, and cleanroom systems. We plan qualification from the design phase because we have seen what happens when it starts when construction ends.",
  faq=[
   ("What is the difference between commissioning and qualification?", "Commissioning is the engineering process of verifying that a system is installed and functions as designed. It is an engineering activity, documented but not necessarily under the quality system. Qualification is the documented, quality-approved verification that the system is fit for its intended GMP use: installation qualification (IQ), operational qualification (OQ), and performance qualification (PQ). Good commissioning makes qualification faster because most problems are found and fixed before protocols are executed."),
 ...
 dict(slug="change-risk-compliance", n="05",
  ...
  scope=[
   ...
   "<strong>Risk management.</strong> A risk register that is actually reviewed, with owners, triggers, mitigations, and dates, and an escalation framework so leadership sees exposure early.",
  ...
  process="Governance is set up in the first weeks of an engagement and runs for the life of the project: a weekly risk and change review, a decision log, and gate packages that show leadership the current exposure. We work inside your quality system, using your change control and document management procedures rather than imposing a parallel one, and we coordinate with quality assurance so engineering changes and quality records stay aligned.",
...
HUB_PAGES = [
 dict(slug="holly-springs", name="Holly Springs", page_title="Engineering Firm for Holly Springs NC", h1="Engineering and CQV Services for Holly Springs, North Carolina",
  ...
  faq=[("Do you have experience with large-scale biologics site startups?","Yes. Our principal has led drug substance and drug product CQV on a large-scale biologics manufacturing site in Holly Springs: aseptic filling lines, automated visual inspection, upstream systems, and site-wide black utilities including chilled water, soft water, heating hot water, steam and potable water."),
