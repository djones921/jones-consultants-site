...
SERVICES = [
 dict(slug="project-engineering", n="01",
  ...
  h1="Project Engineering &amp; Owner's Representation for Pharmaceutical Capital Projects",
  ...
  intro="An owner's representative is the engineer on your side of the table: the one party on a capital project whose only interest is the owner's. JCS Engineering fills that seat for pharmaceutical, biotech, and advanced manufacturing owners in North Carolina — defining scope, driving schedule and budget, coordinating the design firm, contractors, vendors, and quality organization, and holding every one of them to the intent of the project.",
  scope=[
 ...
 dict(slug="engineering-design", n="02",
  ...
  h1="Conceptual and Detailed Design for cGMP Process Facilities",
 ...
 dict(slug="construction-oversight", n="03",
  ...
  h1="Construction Administration and Oversight for Pharmaceutical and Biotech Facilities",
 ...
 dict(slug="cqv", n="04",
  ...
  h1="Commissioning, Qualification and Validation (CQV) Services",
 ...
 dict(slug="optimization-tech-transfer", n="06",
  ...
  h1="Process Optimization and Technology Transfer Engineering",
